...
def main():
    ...
    for idx_fold in range(0, 5):
        ...
        for col in range(2, 12):
            ...
            train_params = {'u': clf.coef_[0], 'w': [], 'b': clf.intercept_}
            pickle.dump(train_params, open('../../../darkweb_data/05/5_31/data_test/v1/fold_'
                                           + str(idx_fold) + '/train_params_' + str(col) + '.pickle', 'wb'))
    ...
    exit()
        ...
        #         if True: #col-2 != l: #corr[col - 2, l] > 0. and ((col-2) != l):
        #             rel_labels.append(l)
        #
