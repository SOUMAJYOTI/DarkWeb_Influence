...
def test_collapsed_parameter_estimation():
    N = 100  # number of observations = Number of docs
    K = 50  # dimension of Dirichlet = number of topics
    W = 200  # number of multinomial trials for each observation = number of words in  docs
    ...
    # print(obs.shape)
    # In fact , obs is the z latent variable in the LDA !!!
    alpha = np.ones(K)
