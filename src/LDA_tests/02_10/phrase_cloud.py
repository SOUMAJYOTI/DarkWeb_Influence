...
fId = 40
output_dir = '../../../darkweb_data/2_2/results/forum/lda_results/40/phrases_month_02_01_2014/'
out_phrases_file = output_dir + 'output_words.txt'
...
dict_phrases = open(output_dir + '/dict_words.txt', 'r')
phrase_freq_dict = {}
...
for t in phrase_cloud_doc:
    ...
    WordCloud.to_file(wordcloud, '../../../plots/wordle_topics/02_15_17/' + t + '.png')
    # plt.figure()
    # plt.show(wordcloud)
    # plt.savefig()
    # plt.close()
