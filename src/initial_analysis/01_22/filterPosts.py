...
def getInputPartitionedPhrases(data, dict, start, tstamps, start_date, end_date):
    word_list = []
    index_vocab = 1
    times = []
    index_doc = 0
    ...
    for line in data:
        ...
        doc_phr = line.split(',')
        if tstamps[index_doc] < start_date or tstamps[index_doc] >= end_date:
            continue
    ...
    thefile = open(directory + '/phrases_month_' + str(start) + '/timestamps.txt', 'w')
...
if __name__ == "__main__":
    fId = 40
    date = '2014-02-01'
    output_dir = '../../../darkweb_data/2_2/nlp_process/forum/' + str(fId) + '/phrases_month_' + date + '/'
    dict_phrases_file = output_dir + 'dict_phrases.txt'
    dict_phrases = open(dict_phrases_file, 'r')

    inp_phrases_file = output_dir + 'InputPartitioned.txt'
    inp_phrases = open(inp_phrases_file, 'r')

    tstamps = []
    timestamps_file  = '../../../darkweb_data/2_2/nlp_process/forum/' + str(fId) + '/timestamps_' + date + '.txt'
    ...
    getInputPartitionedPhrases(inp_phrases, dict_phrases, date, tstamps, start_date, end_date)