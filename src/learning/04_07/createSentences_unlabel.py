...
if __name__ == "__main__":
    ...
    sentences_data = open('../../../darkweb_data/4_8/forum_40_input_phrases_indexed.txt', 'r')
    ...
    pickle.dump(docs, open('../../../darkweb_data/4_8/docs_corpora_label_tfidf.pickle', 'wb'))
