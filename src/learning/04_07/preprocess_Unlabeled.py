...
if __name__ == "__main__":
    forumsData = open('../../../darkweb_data/4_8/unlabeled_data.txt', 'rb')
    ...
    start = 'all'
    directory = '../../../darkweb_data/4_8'
    if not os.path.exists(directory):
        os.makedirs(directory)
    thefile = open(directory + '/forum_' + str(fId) + '_' + 'input_phrases_unlabel.txt', 'w')
    thefile_idx = open(directory + '/forum_' + str(fId) + '_' + 'input_phrases_indexed_unlabel.txt', 'w')
