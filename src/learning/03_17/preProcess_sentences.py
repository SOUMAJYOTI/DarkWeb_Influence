...
def getCorpusPosts(fPosts, timecheck=True):
    ...
    for d in docPosts:
        ...
        for cont in sent_list:
            ...
            #     continue
            # print(temp)
            if temp.lower() not in mdocs_lower_case:
                mdocs.append(temp)
                mdocs_lower_case.append(temp.lower())
            if timecheck:
...
if __name__ == "__main__":
    forumsData = pd.read_csv('../../../darkweb_data/old/2_2/Forumdata_101.csv', encoding="ISO-8859-1")
