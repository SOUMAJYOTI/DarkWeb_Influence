    ...
    for idx_trans in range(5):
        ...
        for idx_fold in range(len(train_fold)):
            ...
            for col_p1 in range(3, 4):
                ...
                """ PHASE 1 FEATURES"""
                X_inst_1, X_inst_3D,  X_u, Y_inst_1, row_indices = \
