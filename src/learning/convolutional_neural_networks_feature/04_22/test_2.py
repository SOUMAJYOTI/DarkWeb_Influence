...
x_train = pickle.load(open(output_dir + 'X_train_l.pickle', 'rb'))
y_train = pickle.load(open(output_dir + 'Y_train_l.pickle', 'rb'))
...
model = Sequential()
model.add(Conv2D(32, kernel_size=(3, img_cols),
                 activation='relu',
